    ...
    <div id="signup-page" className="max-w-md mx-auto py-6 sm:py-8">
      ...
      <div className="rounded-2xl border border-[#DEC8D4] p-7 relative overflow-hidden">
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-[#0F0C0E] tracking-tight">Create Account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          <div>
            <label className="block text-xs font-medium text-[#1F181D] mb-1">
              Full Name
            </label>
            <div className="relative">
              <User className="w-4 h-4 text-[#756770] absolute left-3 top-1/2 -translate-y-1/2" />
              <input
                type="text"
                required
                value={formData.name}
          ...
          <div>
            ...
            <div className="relative">
              <Building2 className="w-4 h-4 text-[#756770] absolute left-3 top-1/2 -translate-y-1/2" />
              <input
                type="text"
