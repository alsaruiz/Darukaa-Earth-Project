...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#DEE3FA] p-2 sm:p-4 md:p-6 lg:p-7 flex flex-col justify-between font-sans selection:bg-[#FCEEF3] selection:text-[#D65D80]">
      ...
      <div className="w-full max-w-7xl mx-auto flex-1 flex flex-col bg-transparent rounded-2xl md:rounded-3xl border border-[#D5DCF5] shadow-2xl shadow-indigo-950/5 overflow-hidden relative">
        ...
        <div className="relative z-10 flex-1 flex flex-col">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    <div className="md:col-span-5 h-80 space-y-4 animate-pulse">
                      ...
                      <div className="h-16 rounded border border-[#DEC8D4] bg-[#FAF5F7]/30" />
                      <div className="h-16 rounded border border-[#DEC8D4] bg-[#FAF5F7]/30" />
                    </div>
          ...
          {/* Clean Footer */}
          <footer className="border-t border-[#DEC8D4]/60 backdrop-blur-xs py-3.5 mt-auto">
            <div className="px-4 sm:px-6 flex items-center justify-between text-xs text-[#332A30]">
              <span className="font-semibold text-[#0F0C0E]">
                Darukaa<span className="text-[#D65D80]">.Earth</span> &copy; 2026
              </span>
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold text-[#332A30]">Syeda Alsa Ruiz</span>
              </div>
            </div>
          </footer>
        </div>
